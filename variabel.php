<?php
    // String
    $string = "Tipe dat string digunakan untuk menampilkan karakter ";

    $namaDepan = 'Axl';
    $namaBelakang = 'Hanuebi';
    $alamat = 'Sentani';
    ...
    $nama = array('Samuel', 'Billy', 'Acho'); // cara lama
    $nama = ['Samuel', 'Billy', 'Acho', 'Calvin', 'Agus']; // cara buat array yang baru
